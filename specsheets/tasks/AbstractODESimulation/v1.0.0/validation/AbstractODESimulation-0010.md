---
id: AbstractODESimulation-0010
rule: When the value of toleranceForRootFinder of an AbstractODESimulation is a reference, it must be a reference to a number.
