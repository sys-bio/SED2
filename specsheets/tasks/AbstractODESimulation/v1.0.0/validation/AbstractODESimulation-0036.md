---
id: AbstractODESimulation-0036
rule: When the value of maxOutputRows of an AbstractODESimulation is a reference, it must be a reference to a positive integer.
