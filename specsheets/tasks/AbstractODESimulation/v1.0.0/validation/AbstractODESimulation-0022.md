---
id: AbstractODESimulation-0022
rule: When the value of forcePhysicalCorrectness of an AbstractODESimulation is a reference, it must be a reference to a boolean.
