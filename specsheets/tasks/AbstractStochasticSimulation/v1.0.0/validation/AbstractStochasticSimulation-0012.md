---
id: AbstractStochasticSimulation-0012
rule: When the value of nonNegative of an AbstractStochasticSimulation is a reference, it must be a reference to a boolean.
