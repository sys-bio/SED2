---
id: AbstractStochasticSimulation-0008
rule: When the value of minimumTimeStep of an AbstractStochasticSimulation is a reference, it must be a reference to a number.
