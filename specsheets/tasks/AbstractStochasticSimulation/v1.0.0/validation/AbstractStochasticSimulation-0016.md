---
id: AbstractStochasticSimulation-0016
rule: When the value of maxNumSteps of an AbstractStochasticSimulation is a reference, it must be a reference to a positive integer.
