---
id: OneStepStochasticSimulation-0005
rule: When the value of independentStep of an OneStepStochasticSimulation is a reference, it must be a reference to a number.
