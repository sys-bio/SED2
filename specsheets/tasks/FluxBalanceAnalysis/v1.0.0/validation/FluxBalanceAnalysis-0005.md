---
id: FluxBalanceAnalysis-0005
rule: When the value of outputVariables of a FluxBalanceAnalysis is a reference, it must be a reference to an array of strings.
